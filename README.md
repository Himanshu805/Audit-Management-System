...
This is our Cognizant MFPE Project made during internship. 
this repo contains 4 microservicesa and Angular UI(frontend app) 
...
There are 4 microservices i.e. User(Authorization), Checklist, Benchmark, Severity , Audit-gateway and  A front-end application(Audit-Ui).
